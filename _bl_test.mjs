...
export const lineOf = (key) => BREATH_LINES.find((l) => l.key === key);
/** 淳くんの声のファイル。public に置いてあるので、料金も通信の心配もない */
export const voiceFile = (key) => `/breath/${key}.mp3`;
/**
 * セリフごとの版（URLの後ろに付ける）。
 *
 ...
 */
export function lineVersion(text) {
    let h = 5381;
