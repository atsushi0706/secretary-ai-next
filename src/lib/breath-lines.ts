...
export const BREATH_LINES: BreathLine[] = [
  {
    /*
     * はじめの一歩（2026-08-12 に淳くんが録り直した 0807.mp4）。
     * 説明は絵（/breath-intro.jpg）が担当。声はこの言葉が入っている。
     */
    key: "intro",
    text: "呼吸から始めようか。目線を15度くらい上げてみて。ゆっくり吸うと、いま必要なものが胸に入ってきて。ゆっくり吐くと、その感覚が全身に行き渡るように。これを3回くらい繰り返して、準備運動おわり。",
    screen: "",   // 画面は絵とテーマの一言（BreathGuide が組む）
  },
  {
    key: "closemouth",
    text: "口を閉じます。",
