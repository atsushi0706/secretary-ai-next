...
export const EP10_ADVENTURE = defineAdventureScenario({
  ...
  nodes: [
    ...
    { kind: "recall", id: "ep10-hypothesis", scene: "調査役の最終判断", purpose: "hypothesis", title: "カードを取り戻すためでも、三人が失ってはいけないものは？", prompt: "リンク「使えば勝てる暗示を前に、僕らは何を失ったら負けなんだろう。」", placeholder: "守るものと理由を書く", helper: "この学校へ入った理由も思い出してください。", storeAs: "ep10Hypothesis", skipLabel: "まだ言葉にできない", skipValue: "本人が自分で選ぶ権利", replyFallback: "本人が自分で選ぶ権利を失ったら、カードだけ戻っても学びは壊れる。" },
