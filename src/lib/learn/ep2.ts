...
const SCENES: Scene[] = [
  {
    ...
    lines: [
      ...
      T("ep2-lec1-3b", "男性を止めていたのは、目の前で意思を奪われた事実ではありません。催眠は意思を失うものだと先に覚えた文化的催眠でした。"),
  ...
  parts: [
    {
      ...
      schoolIntro: {
        ...
        beats: [
          ...
          { who: "teacher", tone: "example", text: "目を閉じるよう促された時、男性は『催眠にかかったら、自分の意思がなくなるんじゃないか』と身構えました。テレビなどで見た催眠の印象が残っていたのです。" },
          { who: "link", tone: "reaction", text: "受けたい気持ちもあるのに、怖くて入口で止まってるんだ。説得したら、余計に警戒されそうです。" },
          { who: "teacher", tone: "reveal", text: "それが、この回で解く文化的催眠です。私は『では、かからないようにしてください』と答えました。" },
    ...
    { kind: "adventure", scenario: EP2_ADVENTURE },
    {
      kind: "classroom",
      intro: {
        title: "『催眠にはかからない』と拒んだ男性が、なぜ自分から目を閉じた？",
        lead: "エリクソンは男性を説得しませんでした。男性は『かからない』と決めたまま、自分のまぶたと呼吸を観察し、目を閉じるかどうかも最後まで自分で選びました。この流れから、拒否を催眠へ利用する原理を整理します。",
        basis: { subjectAnchor: "男性", eventAnchor: "催眠にはかからない", learningGoal: "拒否を否定せず、本人が選べる催眠へ変える原理" },
      },
      scenes: SCENES,
    },
