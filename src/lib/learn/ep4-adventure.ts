...
export const EP4_ADVENTURE = defineAdventureScenario({
  ...
  nodes: [
    ...
    { kind: "recall", id: "ep4-memory", scene: "場面を思い出す", purpose: "memory", title: "リンクが最初に『それは分かる』と言えたものは？", prompt: "リンク「漫画で覚えている、最初に確かめられたものを教えて。」", placeholder: "リンクが確かめられた事実を書く", helper: "一つだけで大丈夫です。", storeAs: "ep4Memory", skipLabel: "まだ思い出せない", skipValue: "足が床についていること", replyFallback: "最初に分かったのは、気持ちではなく身体の事実だったね。" },
    ...
    { kind: "guided-investigation", id: "ep4-guided", scene: "実習記録を読む", title: "言葉が届いた順番を、三段階で確かめる", steps: [
      ...
      { id: "ep4-guide-2", linkPrompt: "ミオは気持ちを当てたのか、見える事実を言ったのかを確かめよう。", actionLabel: "2つ目の記録を見る", evidenceId: "two-facts", linkComment: "足が床にある。息を吐ける。どちらも、その場で僕が確かめられた。", reflectionPrompt: "ミオの二つの言葉に共通することは？", placeholder: "足と呼吸に共通する性質を書く", helper: "正しい助言かではなく、確認できるかを見てください。", storeAs: "ep4Observe2", skipLabel: "まだ分からない", skipValue: "今その場で確かめられる事実", replyFallback: "どちらも、リンクが今うなずける事実だったね。", linkResponse: "{{ep4Observe2Reply}} 最後に、事実の後で何を頼んだか見よう。" },
    ...
    { kind: "deduction", id: "ep4-deduction-2", scene: "最終推理", title: "この催眠誘導で、していないことはどれ？", prompt: "本人の体験に合わせることと、相手を操ることを分けてください。", questionBasis: { subject: "リンクとミオへの催眠誘導", before: "緊張して言葉が出なかった時", asks: "この方法が相手へ強制していないもの", goal: "ペーシングと操作を混同せず説明する" }, options: [
