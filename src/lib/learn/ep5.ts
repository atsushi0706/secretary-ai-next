...
export const EP5: Episode = {
  ...
  parts: [
    ...
    { kind: "classroom", intro: { title: "混乱が残っているのに、なぜ次の一手を選べた？", lead: "答えを急いで作らず、現在の事実、まだ分からない意味、今できる確認へ注意を分けました。" }, scenes: SCENES },
    ...
    { kind: "teaser", manga: [{ rows: [{ panels: [{ art: "broken-card", narr: "保管庫の奥に、一枚だけ破れた紙が残っていた。" }] }, { panels: [{ art: "note-close", big: ["あなたは、", "もう生徒ではない。"] }, { art: "link-resolve", say: { who: "リンク", text: "送信元を追おう。" } }] }] }], hook: ["原理カードは戻らない。", "ミオの目的を追う、最初の校外調査が始まる。"], next: { no: "第6話", title: "暗示をかけたのは、誰？", series: "変態催眠学者の催眠の極意06", principle: "他人の言葉と、自分で受け入れた前提を見分ける" }, preview: { caseNo: "NEXT CASE 06", first: { who: "清瀬リンク", text: "この映像、送られた場所が学校の外です。" }, teacher: "では次は、誰の言葉を信じたのかではなく、どの前提を受け入れたかを調べましょう。" }, unlock: ["🔒 第6話は準備中"] },
  ],
