...
export const EP8_ADVENTURE = defineAdventureScenario({
  ...
  nodes: [
    ...
    { kind: "recall", id: "ep8-memory", scene: "答えのない物語", purpose: "memory", title: "最初の一場面だけなら、鳥をどう見た？", prompt: "リンク「正解じゃなくていい。最初に感じたことを教えて。」", placeholder: "鳥をどう見たか一言で書く", helper: "泥棒、怖い、理由があるかも、どれでも大丈夫です。", storeAs: "ep8Memory", skipLabel: "まだ決めない", skipValue: "鍵を持ち出した理由は分からない", replyFallback: "最初は、鍵を持ち出した行動しか見えないよね。" },
    ...
    { kind: "guided-investigation", id: "ep8-guided", scene: "物語の意味を探す", title: "一場面ずつ、見方がどう変わるか確かめる", steps: [
      { id: "ep8-guide-1", linkPrompt: "最初は、鳥が鍵を持ち出した場面。ここで分かることだけを見よう。", actionLabel: "物語 1/3 を読む", evidenceId: "bird-one", linkComment: "鍵を運んだのは事実。でも泥棒は、仲間が付けた意味だ。", reflectionPrompt: "鳥について、まだ分からないことは？", placeholder: "理由や目的について書く", helper: "行動と目的を分けてください。", storeAs: "ep8Observe1", skipLabel: "まだ分からない", skipValue: "なぜ鍵を運んだかは不明", replyFallback: "鍵を運んだ理由は、まだ物語に出ていない。", linkResponse: "{{ep8Observe1Reply}} 次の場面で、鍵のあった場所に何が起きるか見よう。" },
    ...
    { kind: "recall", id: "ep8-hypothesis", scene: "物語から生まれた仮説", purpose: "hypothesis", title: "ミオが物語で伝えようとした可能性は？", prompt: "リンク「答えを一つにせず、今いちばん確かめたい仮説を教えて。」", placeholder: "物語と事件をつなぐ仮説を書く", helper: "カードを持ち出した理由と、別の影を考えてください。", storeAs: "ep8Hypothesis", skipLabel: "まだ決められない", skipValue: "カードを誰かから守った可能性を確かめたい", replyFallback: "ミオがカードを守るために持ち出した可能性を、本人に確かめたいね。" },
    ...
    { kind: "deduction", id: "ep8-deduction-1", scene: "第一推理", title: "この物語を読んだ後、確かめるべきことは？", prompt: "物語の意味を事実にせず、次の質問へ変えてください。", questionBasis: { subject: "ミオが残した鍵を運ぶ鳥の物語", before: "三場面を読み終えた後", asks: "事件で次に確認する仮説", goal: "メタファーを一つの正解として押し付けず本人への質問へつなげる" }, options: [
