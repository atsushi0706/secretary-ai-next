...
export const EP9_ADVENTURE = defineAdventureScenario({
  ...
  nodes: [
    ...
    { kind: "recall", id: "ep9-memory", scene: "見つけたミオ", purpose: "memory", title: "ミオの言葉に、二つの気持ちはあった？", prompt: "リンク「戻れないだけじゃない。もう一つ、何と言っていた？」", placeholder: "望みと怖さを分けて書く", helper: "『戻りたい』と『戻れない』の両方を見てください。", storeAs: "ep9Memory", skipLabel: "二つを聞く", skipValue: "戻りたいが、壊すのが怖くて戻れない", replyFallback: "戻りたい望みと、壊すのが怖い気持ちが同時にあるね。" },
    ...
    { kind: "guided-investigation", id: "ep9-guided", scene: "動ける可能性", title: "言葉・視線・距離から、選べる一歩を探す", steps: [
      { id: "ep9-guide-1", linkPrompt: "まずミオの言葉。戻りたい望みと、戻れない怖さを両方残そう。", actionLabel: "1つ目を確かめる", evidenceId: "mio-words", linkComment: "どちらかを否定すると、ミオの今の体験から外れる。", reflectionPrompt: "ミオへ否定せず返すなら、何を認める？", placeholder: "二つの気持ちを短く書く", helper: "両方あってよい形にしてください。", storeAs: "ep9Observe1", skipLabel: "両方を認める", skipValue: "戻りたい気持ちも怖さもある", replyFallback: "戻りたい気持ちも、壊すのが怖い気持ちもある。", linkResponse: "{{ep9Observe1Reply}} 次は、言葉と一緒に体が向いている場所を見る。" },
